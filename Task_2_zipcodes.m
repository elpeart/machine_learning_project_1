...
fprintf('Training accuracy for this Bayesian classifier on the zip code data is %2.2f%%\n',train_accuracy*100)
...
fprintf('Testing accuracy for this Bayesian classifier on the zip code data is %2.2f%%\n',test_accuracy*100)