...
classifier_train = [mvnpdf(Train(:,1:2), mu_train_0, sigma_train_0), mvnpdf(Train(:,1:2), mu_train_1, sigma_train_1)];
...
fprintf('Training accuracy for this naive Bayesian classifier on the generated data is %2.2f%%\n',train_accuracy*100)
...
title('Classified Training Data - Naive Bayesian')
legend('Class 1', 'Class 0')
saveas(f1, 'Naive Bayesian Classification of Training Data.jpg')

classifier_test = [mvnpdf(Test(:,1:2), mu_train_0, sigma_train_0), mvnpdf(Test(:,1:2), mu_train_1, sigma_train_1)];
...
fprintf('Testing accuracy for this naive Bayesian classifier on the generated data is %2.2f%%\n',test_accuracy*100)
...
title('Classified Testing Data - Naive Bayesian')
legend('Class 1', 'Class 0')
saveas(f2, 'Naive Bayesian Classification of Testing Data.jpg')